...
startHvH:-starting_state(Board), show_board(Board), humanVhuman(Board, 1).
...
decide_white_play(Board, Line, Column, Result, Line_store, Column_store):-
    ...
    ( (write('OP1'),simulate_play(Board, Line1, Column1, Line1, Column2, 2, 3) ,  Line1 =< 9, Column2 =< 9 )-> write('pintou 2'), computer_set(Board, Result, 2, Line1, Column1, Line1, Column2), Line_store = Line1, Column_store = Column2,  !; 
        (write('OP2'),Line2 is Line-1 , (simulate_play(Board, Line2, Column1, Line2, Column2, 2 , 3), Line2 > 0 , Column2 =< 9 )->  computer_set(Board, Result, 2, Line2, Column1, Line2, Column2), Line_store = Line2, Column_store = Column2, ! ; 
            ( (write('OP3'),simulate_play(Board, Line, Column1, 2) , Column1 =< 9 )-> computer_set(Board, Result, 2, Line, Column1) , Line_store = Line, Column_store = Column1, ! ; 
                ( (write('OP4'),simulate_play(Board, Line1, Column1, 2), Line1 =< 9 )-> computer_set(Board, Result, 2, Line1, Column1) , Line_store = Line1, Column_store = Column1,! ; 
                    ( (write('OP5'),Line2 is Line-1 ,simulate_play(Board, Line2, Column2, 2), Line2 > 0 , Column2 =< 9  )-> computer_set(Board, Result, 2, Line2, Column2) , write('chega aqui'), Line_store = Line2, Column_store = Column2, ! ; 
                        (write('OP6'),Column3 is Column-1, Line3 is Line+2, write('COLUMN3: '),write(Column3), ( simulate_play(Board, Line1, Column3, Line3, Column3, 2, 2), Column3 > 0 , Line3 =< 9 )-> computer_set(Board, Result, 2, Line1, Column3, Line3, Column3), Line_store = Line3, Column_store = Column3, !;
                            ( (write('OP7'), Column3 is Column-1,simulate_play(Board, Line1, Column3, 2), Column3 > 0 )-> computer_set(Board, Result,2, Line1, Column3), Line_store = Line1, Column_store = Column3, write('saiu'),! ; 
                                write('OP8'),decide_white_play_rand(Board, Result, Line_store, Column_store)))))))).

decide_black_play(Board, 0, Column, Result, Line_store, Column_store):-
    write('entrou primeira'),
...
decide_black_play(Board, Line, Column, Result, Line_store, Column_store):-
    ...
    Column1 is Column+1,
    %write('Column1 : '), write(Column1), nl, write('Column2 :'), write(Column2),nl, write('Line1: '), write(Line1),nl,
    ( ( write('OP1'),simulate_play(Board, Line1, Column1, Line2, Column1, 1, 2) ,  Column1 =< 9, Line2 =< 9 )-> write('pintou 2'), computer_set(Board, Result, 1, Line1, Column1, Line2, Column1), Line_store = Line2, Column_store = Column1,  !; 
        (write('OP2') ,Column2 is Column-1 , (simulate_play(Board, Line1, Column2, Line2, Column2, 1 , 2), Column2 > 0 , Line2 =< 9 )->  computer_set(Board, Result, 1, Line1, Column2, Line2, Column2), Line_store = Line2, Column_store = Column2, ! ; 
            ( (write('OP3'),simulate_play(Board, Line1, Column, 1) , Line1 =< 9 )-> computer_set(Board, Result, 1, Line1, Column) , Line_store = Line1, Column_store = Column, ! ; 
                ( (write('OP4'),simulate_play(Board, Line1, Column1, 1), Line1 =< 9 )-> computer_set(Board, Result, 1, Line1, Column1) , Line_store = Line1, Column_store = Column1,! ; 
                    ( (write('OP5'),Column2 is Column-1 ,simulate_play(Board, Line2, Column2, 1), Column2 > 0 , Line2 =< 9  )-> computer_set(Board, Result, 1, Line2, Column2) , Line_store = Line2, Column_store = Column2, ! ; 
                        (write('OP6'),Line3 is Line-1,write('LINE3: '),write(Line3), Column3 is Column+2,  ( simulate_play(Board, Line3, Column1, Line3, Column3, 1, 3), Line3 > 0 , Column3 =< 9 )-> computer_set(Board, Result, 1, Line1, Column3, Line3, Column3), Line_store = Line3, Column_store = Column3, !;
                            ( ( write('OP7'),Line3 is Line-1,simulate_play(Board, Line3, Column1, 1), Line3 > 0 )-> computer_set(Board, Result,1, Line3, Column1), Line_store = Line3, Column_store = Column1,! ; 
                                write('OP8'),decide_black_play_rand(Board, Result, Line_store, Column_store)))))))).
